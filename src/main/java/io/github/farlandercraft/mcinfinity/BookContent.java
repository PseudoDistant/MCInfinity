...
public interface BookContent {
    ...
    public static class WritableBookContents implements BookContent {
        ...
        private static List<String> getPages(ItemStack stack) {
            ...
            return (List)(compoundTag != null ? BookContent.fromTag(compoundTag) : ImmutableList.of());
        }
    ...
    public static class WrittenBookContents implements BookContent {
        ...
        private static List<String> getPages(ItemStack stack) {
            CompoundTag compoundTag = stack.getTag();
            return (List)(compoundTag != null && WrittenBookItem.isValid(compoundTag) ? BookContent.fromTag(compoundTag) : ImmutableList.of((new TranslatableText("book.invalid.tag", new Object[0])).formatted(Formatting.DARK_RED)));
        }
